...
public interface Character {
    ...
    public default Animation<TextureRegion> getAnimation(){
        return animation;
    }

    public default void setAnimationWalkUp(){}

    public default void setAnimationWalkDown(){}

    public default void setAnimationWalkRight(){}

    public default void setAnimationWalkLeft(){}

    public default Skill getSkill(){
        return skill;
    }

    public default String getNama(){
        return nama;
    }
}
